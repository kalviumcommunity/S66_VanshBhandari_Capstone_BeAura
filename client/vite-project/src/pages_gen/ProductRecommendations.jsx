...
{/*  Top Navigation Bar  */}
<nav className="fixed top-0 w-full z-50 bg-[#faf9f6]/70 backdrop-blur-xl no-border">
<div className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto">
<div className="font-noto-serif text-2xl font-bold text-primary tracking-tighter">BeAura</div>
<div className="hidden md:flex gap-10 items-center">
<a className="font-noto-serif text-lg tracking-tight text-primary font-semibold border-b-2 border-primary pb-1" href="#">Home</a>
<a className="font-noto-serif text-lg tracking-tight text-on-surface-variant hover:text-primary transition-colors" href="#">About</a>
<a className="font-noto-serif text-lg tracking-tight text-on-surface-variant hover:text-primary transition-colors" href="#">Services</a>
</div>
...
<button className="bg-primary text-on-primary px-6 py-2 rounded-full font-label text-xs tracking-widest uppercase hover:opacity-90 transition-all">Login</button>
</div>
</div>
</nav>
...
{/*  Ingredient Chip Concept (Floating element for interactive feel)  */}

...
{/*  TopNavBar  */}
<header className="fixed top-0 w-full z-50 bg-[#faf9f6]/70 dark:bg-[#1a1c1a]/70 backdrop-blur-xl no-border bg-[#f4f3f1] dark:bg-[#252822]">
...
<a className="text-[#45483c] dark:text-[#e3e2e0] hover:text-[#3e5219] transition-colors font-noto-serif text-lg tracking-tight" href="#">Services</a>
</nav>
<div className="flex items-center gap-4">
<button className="px-6 py-2 rounded-full font-medium text-sm transition-all duration-200 ease-out bg-primary text-on-primary hover:opacity-90 active:scale-95">Login</button>
</div>
</div>
</header>
...
<div className="aspect-square bg-surface-variant/20 rounded-lg overflow-hidden relative">
<img className="w-full h-full object-cover opacity-60 grayscale" data-alt="Close up texture of healthy skin" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDu6l7N76SXlhmJ5AchZusChXKq4eholyWkMyhjFxjEh7AU_sPmYEPJcaD3A4bXziGoH-vMVd0_iwR3qoGhE_YtUp12Jf8iUNkZt1lNGdqRVB3PFYb5LuTTrGPp8slQVjhe7wPreJsnjZkOuorK7BHag0tMOd2J4xrXocwuih-f5VWW-a8gkW3TvUhKTiRS7oMk12fgz9xeN5uCLsOMYdLX8fA6EuxbPtFUFpOkIPxPRjpVmjY79t1ttnIAxj8tYUTD4UZ0FVUhofBM"/>
</div>
<div className="aspect-square bg-surface-variant/20 rounded-lg overflow-hidden flex items-center justify-center">
...
{/*  Why BeAura Trust Badge Section  */}
...
{/*  Footer  */}
<footer className="w-full mt-16 bg-[#f4f3f1] dark:bg-[#1a1c1a] tonal-shift bg-[#f4f3f1] dark:bg-[#252822]">

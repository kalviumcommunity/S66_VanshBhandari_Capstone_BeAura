...
<a className="font-noto-serif text-lg tracking-tight text-[#3e5219] font-semibold border-b-2 border-[#3e5219] pb-1" href="#">Home</a>
<a className="font-noto-serif text-lg tracking-tight text-[#45483c] hover:text-[#3e5219] transition-colors" href="#">About</a>
<a className="font-noto-serif text-lg tracking-tight text-[#45483c] hover:text-[#3e5219] transition-colors" href="#">Services</a>
</div>
<button className="bg-primary text-on-primary px-6 py-2 rounded-full font-medium scale-95 duration-200 ease-out hover:bg-primary-container transition-all">Login</button>
</div>
</nav>
{/*  Main Content Container (Split Screen)  */}
<main className="pt-20 h-screen flex flex-col md:flex-row">
{/*  Sidebar: Clinic List & Filters  */}
<aside className="w-full md:w-[420px] lg:w-[480px] bg-surface flex flex-col border-r border-outline-variant/15 z-10">
...
<div className="absolute inset-0 grayscale opacity-40 mix-blend-multiply" data-alt="Abstract minimalist map pattern with soft neutral tones" data-location="London" style={{backgroundImage: 'url("https', backgroundSize: 'cover', backgroundPosition: 'center'}}>
</div>
...
{/*  Footer (Suppressed based on focused task context but kept minimal as per rules if needed)  */}
<footer className="fixed bottom-0 w-full z-40 bg-[#f4f3f1] md:hidden">
<div className="flex justify-around items-center px-4 py-3">
<div className="flex flex-col items-center gap-1 text-[#3e5219]">
